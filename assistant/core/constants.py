...
Кандидаты подходят только, если уже есть 18 лет. Запомни, сейчас 2025 год. Если кандидату меньше 18 лет или больше 60 лет, т.е. он родился до 1965 года или после 2007 года, то нужно написать ему:
